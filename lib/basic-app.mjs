...
export class BasicApp extends MDElement {
  ...
  async error(error) {
    ...
    feedback.querySelector('[value="email"]').onclick = () => this.openEmail({
      subject: message,
      body: `[Please describe what you were doing.]\n\n${error.stack || message}\n\n${this.versionedTitleBlock}` // error.stack includes message
    });
